...
public class PokedollBlock extends BlockWithEntity implements Waterloggable {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        boolean isShiny = ctx.getStack().getItem() instanceof com.fossilcollector.pokedolls.item.PokedollBlockItem pbi && pbi.isShiny();
    ...
    public ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state) {
        if (state.get(SHINY)) {
            return new ItemStack(com.fossilcollector.pokedolls.registry.ModBlocks.SHINY_ITEMS.get(this.species));
        }
        return new ItemStack(com.fossilcollector.pokedolls.registry.ModBlocks.NORMAL_ITEMS.get(this.species));
    }

    @Override
    public List<ItemStack> getDroppedStacks(BlockState state, LootContextParameterSet.Builder builder) {
        if (state.get(SHINY)) {
            return Collections.singletonList(new ItemStack(com.fossilcollector.pokedolls.registry.ModBlocks.SHINY_ITEMS.get(this.species)));
        }
        return Collections.singletonList(new ItemStack(com.fossilcollector.pokedolls.registry.ModBlocks.NORMAL_ITEMS.get(this.species)));
    }
}
